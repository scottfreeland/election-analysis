...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percentage = float(county_vote_count) / float(total_votes)\
            * 100
        ...
        # 6f: Write an if statement to determine the winning county and get
        # its vote count.
        if (county_vote_count > largest_turnout_vote):
            # If true then set winning_count = votes and winning_percent =
            # vote_percentage.
            largest_turnout_vote = county_vote_count
            # And set the largest_turnout_county equal to the county's name.
